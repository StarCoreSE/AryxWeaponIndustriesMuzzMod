...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef AryxGaussAmmoWC => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Health = 125, // How much damage the proj ectile can take from other projectiles (base of 1 per hit) before dying; 0 disables this and makes the projectile untargetable.
