    ...
    partial class Parts
    {
        private AmmoDef AryxSmallFocusBeamLanceAmmo => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            Beams = new BeamDef
            {
                ...
                FakeVoxelHitTicks = 600, // If this beam hits/misses a voxel it assumes it will continue to do so for this many ticks at the same hit length and not extend further within this window.  This can save up to n times worth of cpu.
            },
